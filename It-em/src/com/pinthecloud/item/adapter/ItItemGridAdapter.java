...
public class ItItemGridAdapter extends ArrayAdapter<Item> {

	private Context mContext;
	private ItFragment mFrag;


	public ItItemGridAdapter(Context context, ItFragment frag) {
		super(context, 0);
	...
	private static class ViewHolder {
		...
		public ViewHolder(View view) {
			this.view = view;
			this.rank = (TextView)view.findViewById(R.id.row_it_item_grid_rank);
